        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 text-center flex flex-col items-center gap-1">
              ...
              <h3 className="text-white font-serif font-semibold text-xl md:text-3xl lg:text-4xl uppercase tracking-wide mt-1" style={{ textShadow: '0.75px 0.75px 0 #D4AF37, -0.75px -0.75px 0 #D4AF37, 0.75px -0.75px 0 #D4AF37, -0.75px 0.75px 0 #D4AF37' }}>
                [KON-FI-DUHNS]
              </h3>
            </div>
