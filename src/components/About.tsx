    ...
    <section id="about" className="py-24 px-4 bg-black fade-on-scroll opacity-0">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20 flex flex-col items-center leading-none">
          ...
          <h3 className="text-gold font-serif font-bold text-3xl md:text-5xl lg:text-6xl uppercase tracking-wider mb-5" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.8)' }}>
            Your
          </h3>
